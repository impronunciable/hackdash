...
function sendDashboards(req, res){
  res.send(req.dashboards);
}

function sendDashboardCSV(req, res){
  var domain = req.dashboard.domain;
...
app.post('/dashboards', helpers.isAuth, validateSubdomain, createDashboard, sendDashboard);
app.get('/dashboards', cors(), setQuery, setDashboards, sendDashboards);

app.get('/dashboards/:domain/csv', helpers.isAuth, getDashboard, isAdminDashboard, sendDashboardCSV);
...
app.put('/dashboards/:domain', helpers.isAuth, getDashboard, isAdminDashboard, updateDashboard, sendDashboard);
app.put('/', helpers.isAuth, getDashboard, isAdminDashboard, updateDashboard, sendDashboard);

app.delete('/dashboards/:domain', helpers.isAuth, getDashboard, isOwnerDashboard, removeDashboard);

app.post('/', helpers.notAllowed);
app.delete('/', helpers.notAllowed);
